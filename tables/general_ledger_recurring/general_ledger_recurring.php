...
class tables_general_ledger_recurring {
	...
	function getPermissions(&$record){
		...
		if( isUser() ){
			...
			if ( isset($record) ){
				return Dataface_PermissionsTool::getRolePermissions('NO_DELETE');
			}
		}
		else
	...
	function getTitle(&$record){
		return $record->val('recurring_ledger_description');
	}
	...
	function section__journal(&$record){
		...
		$jr = $record->getRelatedRecords('general_ledger_recurring_journal');
