...
class actions_purchase_order_post_rendered_services {
	
	function handle(&$params){

		$poTable = "purchase_order_rendered_services";
		$poItemTable = "purchase_order_rendered_services_items";
		$po_type = "purchase_order_post_rendered_services";
		$id_prefix = "R";
